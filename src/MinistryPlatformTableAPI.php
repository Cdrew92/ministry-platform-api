...
class MinistryPlatformTableAPI extends MinistryPlatformBaseAPI
{
    ...
    /**
     * List of IDs to be used in a postGet() call
     */
    protected $idList = null;

    /**
     * MP UserID - PK on users table
     */
    ...
    /**
     * Set the userID of the user performing this operation
     * @param int $userID
     */
    ...
    /**
     * Set the GLobal Filter ID for filtering purposes
     * @param int $ID
     */
    public function globalFilterId($gfID)
    {
        $this->globalFilterID = $gfID;
    ...
    /**
     * GSM Executes a POST request to GET data
     *
     * POST verb overcomes the 2048 char length limitation of a GET
     * querystring
     */
    public function postGet()
    {
        ...
        // Set the endpoint and append the required get to the end of the url
        $endpoint = $this->buildEndpoint() . 'get';
        ...
        do {
            try {
                ...
                $this->records([
                    ...
                    'userId' => $this->userID,
                    'globalFilterId' => $this->globalFilterID
                ]);
